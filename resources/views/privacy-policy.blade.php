                                    ...
                                    <div class="col-md-10 col-sm-12 policy">                
                                        <div class="card-body pt-9 pb-9"> 
                                            ...
                                            <div class="mb-7">
                                                {!! $pages['privacy'] !!}
												<div class="container">
													<h1 class="mt-5 mb-4">Politique de confidentialité</h1>
												
													<div class="row">
														<div class="col-md-12">
															<p><strong>Dernière mise à jour : {{date('Y')}}</strong></p>
															<p>Veuillez lire attentivement cette politique de confidentialité avant d'utiliser le site web IntelOmega.</p>
														</div>
													</div>
													...
													<div class="row">
														<div class="col-md-12">
															...
															<p>Nous collectons différentes informations pour améliorer votre expérience sur notre site...</p>
